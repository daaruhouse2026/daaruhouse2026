...
const MENU_DATA = [
  ...
  // ── Veg Starters ────────────────────────────────────────
  { id: 20, name: "Onion Pakoda",                price: 100, cat: "Starters",  veg: true,  emoji: "🧅",image:"images/menu/VegStarters/OnionPakoda.jpg" },
  { id: 21, name: "French Fries",                price: 100, cat: "Starters",  veg: true,  emoji: "🍟" ,image:"images/menu/vegStarters/FrenchFries.jpg"},
  { id: 22, name: "Fry Peanut Masala",           price: 100, cat: "Starters",  veg: true,  emoji: "🥜",image:"images/menu/vegStarters/FryPeanutMasala.jpg" },
  { id: 23, name: "Boiled Peanut Masala",        price: 100, cat: "Starters",  veg: true,  emoji: "🥜",image:"images/menu/vegStarters/BoiledPeanutMasala.jpg" },
  { id: 24, name: "Veg Manchuria",               price: 150, cat: "Starters",  veg: true,  emoji: "🥦" ,image:"images/menu/vegStarters/VegManchuria.jpg"},
  { id: 25, name: "Gobi Manchuria",              price: 170, cat: "Starters",  veg: true,  emoji: "🥦" ,image:"images/menu/vegStarters/GobiManchuria.jpeg"},
  { id: 26, name: "Crispy Baby Corn",            price: 150, cat: "Starters",  veg: true,  emoji: "🌽" ,image:"images/menu/vegStarters/CrispyBabyCorn.jpg"},
  { id: 27, name: "Chilli Paneer",               price: 180, cat: "Starters",  veg: true,  emoji: "🧀" ,image:"images/menu/vegStarters/ChilliPaneer.jpg"},
  { id: 28, name: "Paneer Pakoda",               price: 180, cat: "Starters",  veg: true,  emoji: "🧀" ,image:"images/menu/vegStarters/PaneerPakoda.jpg"},
  { id: 29, name: "Roasted Papad (2 pcs)",       price: 20,  cat: "Starters",  veg: true,  emoji: "🫓" ,image:"images/menu/vegStarters/RoastedPapad.jpg"},
  { id: 30, name: "Masala Papad (2 pcs)",        price: 50,  cat: "Starters",  veg: true,  emoji: "🫓" ,image:"images/menu/vegStarters/MasalaPapad.jpg"},

  // ── Non-Veg Starters ────────────────────────────────────
  { id: 31, name: "Boiled Egg (2 pcs)",          price: 40,  cat: "Starters",  veg: false, emoji: "🥚" ,image:"images/menu/Non-VegStarters/BoiledEgg.jpg"},
  { id: 32, name: "Masala Omlet",                price: 50,  cat: "Starters",  veg: false, emoji: "🍳" ,image:"images/menu/Non-VegStarters/MasalaOmlet.jpg"},
  { id: 33, name: "Egg Burji",                   price: 100, cat: "Starters",  veg: false, emoji: "🍳" ,image:"images/menu/Non-VegStarters/EggBurji.jpg"},
  { id: 34, name: "Chicken Nuggets (8 pcs)",     price: 100, cat: "Starters",  veg: false, emoji: "🍗" ,image:"images/menu/Non-VegStarters/ChickenNuggets.jpg"},
  { id: 35, name: "Chilli Chicken",              price: 170, cat: "Starters",  veg: false, emoji: "🌶️" ,image:"images/menu/Non-VegStarters/ChilliChicken.jpg"},
  { id: 36, name: "Chicken 65",                  price: 170, cat: "Starters",  veg: false, emoji: "🍗" ,image:"images/menu/Non-VegStarters/Chicken65.jpg"},
  { id: 37, name: "Chicken Lollipop (6 pcs)",    price: 180, cat: "Starters",  veg: false, emoji: "🍖" ,image:"images/menu/Non-VegStarters/ChickenLollipop.jpg"},
  { id: 38, name: "Chicken Manchuria",           price: 170, cat: "Starters",  veg: false, emoji: "🍗" ,image:"images/menu/Non-VegStarters/ChickenManchuria.jpeg"},
  { id: 39, name: "Chicken Pakoda",              price: 150, cat: "Starters",  veg: false, emoji: "🍗" ,image:"images/menu/Non-VegStarters/ChickenPakoda.jpg"},
  { id: 40, name: "Chicken Pop Corn",            price: 150, cat: "Starters",  veg: false, emoji: "🍿" ,image:"images/menu/Non-VegStarters/ChickenPopCorn.jpg"},
  { id: 41, name: "Cashewnut Chicken",           price: 200, cat: "Starters",  veg: false, emoji: "🍗" ,image:"images/menu/Non-VegStarters/CashewnutChicken.jpg"},
  { id: 42, name: "Chilli Prawn",                price: 200, cat: "Starters",  veg: false, emoji: "🦐" ,image:"images/menu/Non-VegStarters/ChilliPrawn.jpg"},
  { id: 43, name: "Butter Garlic Prawns",        price: 200, cat: "Starters",  veg: false, emoji: "🦐" ,image:"images/menu/Non-VegStarters/ButterGarlicPrawn.jpg"},
  { id: 44, name: "Chicken Keema Balls",         price: 200, cat: "Starters",  veg: false, emoji: "🍖" ,image:"images/menu/Non-VegStarters/ChickenKeemaBalls.jpg"},
  { id: 45, name: "Tawa Fish",                   price: 100, cat: "Starters",  veg: false, emoji: "🐟" ,image:"images/menu/Non-VegStarters/TawaFish.jpg"},
  { id: 46, name: "Chilli Fish",                 price: 150, cat: "Starters",  veg: false, emoji: "🐟" ,image:"images/menu/Non-VegStarters/ChilliFish.jpeg"},

  // ── Veg Main Course ─────────────────────────────────────
  { id: 47, name: "Aloo Mutter Masala",          price: 140, cat: "Main Course", veg: true,  emoji: "🥔",image:"images/menu/VegMainCourse/AlooMutterMasala.jpg" },
  { id: 48, name: "Gobi Masala",                 price: 140, cat: "Main Course", veg: true,  emoji: "🥦",image:"images/menu/VegMainCourse/GobiMasala.jpg" },
  { id: 49, name: "Baby Corn Masala",            price: 140, cat: "Main Course", veg: true,  emoji: "🌽",image:"images/menu/VegMainCourse/BabyCornMasala.jpg" },
  { id: 50, name: "Kadai Veg",                   price: 140, cat: "Main Course", veg: true,  emoji: "🥘",image:"images/menu/VegMainCourse/KadaiVeg.jpeg" },
  { id: 51, name: "Mix Veg Curry",               price: 150, cat: "Main Course", veg: true,  emoji: "🍛",image:"images/menu/VegMainCourse/MixVegCurry.jpg" },
  { id: 52, name: "Tomato Curry",                price: 120, cat: "Main Course", veg: true,  emoji: "🍅",image:"images/menu/VegMainCourse/TomatoCurry.jpeg" },
  { id: 53, name: "Kaju Tomato Curry",           price: 170, cat: "Main Course", veg: true,  emoji: "🥜",image:"images/menu/VegMainCourse/KajuTomatoCurry.jpg" },
  { id: 54, name: "Kaju mutter Masala",          price: 150, cat: "Main Course", veg: true,  emoji: "🌿",image:"images/menu/VegMainCourse/KajuMutterMasala.jpg" },
  { id: 55, name: "Chole Masala",                price: 120, cat: "Main Course", veg: true,  emoji: "🫘",image:"images/menu/VegMainCourse/CholeMasala.jpg" },
  ...
  { id: 57, name: "Palak Paneer",                price: 180, cat: "Main Course", veg: true,  emoji: "🌿",image:"images/menu/VegMainCourse/PalakPaneer.jpg" },
  { id: 58, name: "Shahi Paneer",                price: 180, cat: "Main Course", veg: true,  emoji: "🧀",image:"images/menu/VegMainCourse/ShahiPaneer.jpg" },
  { id: 59, name: "Kadai Paneer",                price: 180, cat: "Main Course", veg: true,  emoji: "🧀",image:"images/menu/VegMainCourse/KadaiPaneer.jpg" },
  { id: 60, name: "mutter Paneer",               price: 180, cat: "Main Course", veg: true,  emoji: "🌿",image:"images/menu/VegMainCourse/PaneerButterMasala.jpg" },
  { id: 61, name: "Dal Tadka",                   price: 120, cat: "Main Course", veg: true,  emoji: "🍲",image:"images/menu/VegMainCourse/DalTadka.jpg" },
  { id: 62, name: "Dal Makhani",                 price: 150, cat: "Main Course", veg: true,  emoji: "🍲",image:"images/menu/VegMainCourse/DalMakhani.jpg" },
  { id: 63, name: "Rajma Dal Masala",            price: 120, cat: "Main Course", veg: true,  emoji: "🫘",image:"images/menu/VegMainCourse/RajmaDalMasala.jpg" },

  // ── Non-Veg Main Course ─────────────────────────────────
  { id: 64, name: "Onion Egg Fry",               price: 100, cat: "Main Course", veg: false, emoji: "🍳" ,image:"images/menu/NonVegMainCourse/OnionEggFry.jpg"},
  { id: 65, name: "Egg Masala",                  price: 120, cat: "Main Course", veg: false, emoji: "🥚" ,image:"images/menu/NonVegMainCourse/EggMasala.jpg"},
  { id: 66, name: "Chicken Masala (Bone)",       price: 150, cat: "Main Course", veg: false, emoji: "🍗" ,image:"images/menu/NonVegMainCourse/ChickenMasalaBone.jpg"},
  { id: 67, name: "Chicken Masala (Boneless)",   price: 160, cat: "Main Course", veg: false, emoji: "🍗" ,image:"images/menu/NonVegMainCourse/ChickenMasalaBoneless.jpg"},
  { id: 68, name: "Chicken Chettinad",           price: 170, cat: "Main Course", veg: false, emoji: "🌶️" ,image:"images/menu/NonVegMainCourse/ChickenChettinad.jpg"},
  { id: 69, name: "Butter Chicken",              price: 180, cat: "Main Course", veg: false, emoji: "🧈" ,image:"images/menu/NonVegMainCourse/ButterChicken.jpg"},
  { id: 70, name: "Kadai Chicken",               price: 170, cat: "Main Course", veg: false, emoji: "🍗" ,image:"images/menu/NonVegMainCourse/KadaiChicken.jpg"},
  { id: 71, name: "Mughlai Chicken",             price: 200, cat: "Main Course", veg: false, emoji: "👑" ,image:"images/menu/NonVegMainCourse/MughlaiChicken.jpg"},
  { id: 72, name: "Chicken Keema butter",        price: 180, cat: "Main Course", veg: false, emoji: "🍖" ,image:"images/menu/NonVegMainCourse/ChickenKeemaMutter.jpg"},
  { id: 73, name: "Prawn Masala",                price: 200, cat: "Main Course", veg: false, emoji: "🦐" ,image:"images/menu/NonVegMainCourse/PrawnMasala.jpg"},
  { id: 74, name: "Mutton Masala",               price: 240, cat: "Main Course", veg: false, emoji: "🥩" ,image:"images/menu/NonVegMainCourse/MuttonMasala.jpg"},
  { id: 75, name: "Mutton Rogan Josh",           price: 250, cat: "Main Course", veg: false, emoji: "🍖" ,image:"images/menu/NonVegMainCourse/MuttonRoganJosh.jpg"},
  { id: 76, name: "Mutton Keema Mutter",         price: 280, cat: "Main Course", veg: false, emoji: "🥩" ,image:"images/menu/NonVegMainCourse/MuttonKeemaMutter.jpg"},
  { id: 77, name: "Fish Masala",                 price: 220, cat: "Main Course", veg: false, emoji: "🐟" ,image:"images/menu/NonVegMainCourse/FishMasala.jpg"},
...
const FILTERS = ["All Items", "Breakfast", "Veg", "Non-Veg", "Starters", "Main Course", "Biryani","Rice & Chinese","Indian Bread", "Thali", "Snacks", "Desserts"];
